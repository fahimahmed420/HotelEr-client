      ...
      <div className="max-w-7xl mx-auto min-h-screen flex flex-col px-6 py-28 ">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className={`space-y-5 p-6 rounded-xl ${darkMode ? "bg-gray-800" : "bg-white"}`}>
            ...
            {/* Reserve button */}
            <div className={`h-10 w-full rounded-xl animate-pulse ${darkMode ? "bg-green-600" : "bg-green-400"}`} />
          </div>
          ...
          >
            ...
            <div className="flex justify-end mt-4">
              {/* Review button */}
              <div
                className={`h-10 w-28 rounded-lg animate-pulse ${darkMode ? "bg-blue-600" : "bg-blue-400"
                  }`}
              />
            </div>
          </div>
